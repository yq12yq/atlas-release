...
public class ImportHBaseEntitiesBase {
    ...
    protected  AtlasEntity createOrUpdateTable(String nameSpace, String tableName, AtlasEntity nameSapceEntity, TableDescriptor tableDescriptor, ColumnFamilyDescriptor[] columnFamilyDescriptors) throws Exception {
        String      owner            = tableDescriptor.getOwnerString();
        ...
        List<AtlasEntity>   cfEntities = createOrUpdateColumnFamilies(nameSpace, tableName, owner, columnFamilyDescriptors, tableEntity);
    ...
    protected List<AtlasEntity> createOrUpdateColumnFamilies(String nameSpace, String tableName, String owner, ColumnFamilyDescriptor[] columnFamilyDescriptors , AtlasEntity tableEntity) throws Exception {
        ...
        if (columnFamilyDescriptors != null) {
            ...
            for (ColumnFamilyDescriptor columnFamilyDescriptor : columnFamilyDescriptors) {
                ...
                if (cfEntity == null) {
                    ...
                    AtlasEntity entity = getColumnFamilyEntity(nameSpace, tableName, owner, columnFamilyDescriptor, tableId);
    ...
    private AtlasEntity getColumnFamilyEntity(String nameSpace, String tableName, String owner, ColumnFamilyDescriptor columnFamilyDescriptor, AtlasObjectId tableId){
